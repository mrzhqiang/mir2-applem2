...
resourcestring
  ...
  BS_ADDCUSTOMCOLORBUTTON_CAP = '添加到自定义颜色';
  ...
  BS_DBNAV_FIRST_HINT = '首记录';
  BS_DBNAV_PRIOR_HINT = '前一记录';
  BS_DBNAV_NEXT_HINT = '下一记录';
  BS_DBNAV_LAST_HINT = '末记录';
  BS_DBNAV_INSERT_HINT = '插入记录';
  BS_DBNAV_DELETE_HINT = '删除记录';
  BS_DBNAV_EDIT_HINT = '编辑记录';
  BS_DBNAV_POST_HINT = '保存修改';
  BS_DBNAV_CANCEL_HINT = '取消修改';
  BS_DBNAV_REFRESH_HINT = '刷新记录';
